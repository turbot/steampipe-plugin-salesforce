...
func SalesforceContract(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "company_signed_date", Type: proto.ColumnType_TIMESTAMP, Description: ""},
			...
			{Name: "customer_signed_date", Type: proto.ColumnType_TIMESTAMP, Description: ""},
			...
			{Name: "last_activity_date", Type: proto.ColumnType_TIMESTAMP, Description: ""},
			{Name: "last_approved_date", Type: proto.ColumnType_TIMESTAMP, Description: ""},
			...
			{Name: "start_date", Type: proto.ColumnType_TIMESTAMP, Description: ""},
